...
export default function Signup() {
    ...
    // 리액트 화면에서 입력한 자료를 가지고 백앤드의 주소로 데이터를 넘겨주어야함 (JSON)
    // 입력값을 저장할 상태변수
    ...
    const signup = () => {
        ...
        .then((res) => {
            // 회원가입이 성공했을때 signup_result 페이지로 이동예정
            if(res.data === 1){
                alert("회원가입 성공")
          ...
          <tr>
            ...
            <td>
              <input
                type="text"
                name="id"
                value={id} // 써도 안써도 상관없음. 수정할때 이미 값이 들어가 있어야하니까 수정할때는 있으면 좋음
